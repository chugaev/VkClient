...
public class Api {
    ...
    static boolean enable_compression = false;
    ...
    public ArrayList<User> getFriends(Long user_id, String fields, Integer lid, String captcha_key, String captcha_sid) throws IOException, JSONException, KException{
        ...
        if(array==null)
            return users;
        int category_count = array.length();
        Log.i("etsf", array.toString());
        for(int i=0; i<category_count; ++i){
            JSONObject o = (JSONObject) array.get(i);
            User u = User.parse(o);
            users.add(u);
            Log.i("asd", array.get(i) + "");
        }
    ...
    public int getCountMessagesHistory(long uid, long chat_id) throws IOException, JSONException, KException{
    ...
    public int getCountDialogs() throws IOException, JSONException, KException{
