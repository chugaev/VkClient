...
public class ListOnlineFriendsFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ListOnlineFriendsFragment.GetterFriendsTask getterFriendsTask = new ListOnlineFriendsFragment.GetterFriendsTask();
    ...
    private ArrayList<String> getListFriends() {
        ...
        ArrayList<Long> usersId = null;
        try {
            usersId = mApi.getOnlineFriends(mAccount.getUserId());
            users = mApi.getProfiles(usersId, null,"photo_100", null, null, null);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
